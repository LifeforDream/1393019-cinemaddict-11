...
const MAIN_LIST_FILMS_CARD_COUNT = 5
const EXTRA_LIST_FILMS_CARD_COUNT = 2
...
const createCloseFilmDetailsButton = () => {
  return (
...
const createFilmDetailsCommentSection = () => {
  return (
...
render(siteFilmsElement, createTopRatedFilmsTemplate(), `beforeEnd`);
render(siteFilmsElement, createMostCommentedFilmsTemplate(), `beforeEnd`);
...
for (let i = 0; i < MAIN_LIST_FILMS_CARD_COUNT; i++) {
  render(siteFilmsContainerElement, createFilmCardTemplate(), `beforeEnd`);
}

const extraFilmsContainers = siteFilmsElement.querySelectorAll(`.films-list--extra`)
...
for (let i = 0; i < EXTRA_LIST_FILMS_CARD_COUNT; i++) {
